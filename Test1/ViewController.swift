...
class ViewController: UIViewController, UITextFieldDelegate
{
    ...
    @IBAction func go(_ sender: UIButton, forEvent event: UIEvent)
    {
        ...
        // Fehlermeldung, falls essentielle Werte = 0
        if 
            valuePlayers == 0 || valueSB == 0 || valueBB == 0 || valueStack == 0
        {
            mLabel.text = "Oops"
            zoneLabel.text = "💩"
            explanationLabel.text = "Please provide valid numbers"
        }
        
        // Bedingung, dass alle Felder ausgefüllt sein müssen
        else if
            valuePlayers != nil && valueAnte != nil && valueSB != nil && valueBB != nil && valueStack != nil
        {
        ...
        else
        {
            mLabel.text = "Oops"
            zoneLabel.text = "💩"
            explanationLabel.text = "Some numbers are missing"
        }
    }
